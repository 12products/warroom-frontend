...
const App: Component = () => {
  return (
    <div class="p-5 md:p-0 md:pt-10 md:pb-20 max-w-7xl mx-auto space-y-32 md:space-y-64 relative">
      <header class="md:pb-18">
        <Nav />

        <div class="h-screen relative pt-20 md:pt-0">
          <div class="relative flex flex-col justify-center h-full z-10 pointer-events-none">
            <div class="md:w-2/3 bg-gray-800 bg-opacity-25 p-10 rounded-t">
              <h1 class="text-6xl md:text-7xl leading-none font-bold mb-6">
            ...
            <div class="bg-gray-900 md:w-2/3 p-10 rounded-b pointer-events-auto">
      ...
      <section class="md:flex items-center space-y-10 md:space-y-0">
        <div class="md:w-1/2 bg-gray-800 bg-opacity-50 p-10 rounded">
          <h2 class="text-4xl md:text-5xl leading-none font-bold mb-4">
        ...
        <div class="mx-auto md:w-1/2">
          <div class="mx-auto bg-white w-2/3 p-5 rounded">
            ...
            <div class="text-gray-600 mt-2">Service Status</div>
            ...
            <div class="text-gray-600 mt-4 mb-2">Past Incidents</div>

            <div class="w-1/3 bg-gray-300 h-4 rounded"></div>
            <div class="w-2/3 mt-2 bg-gray-300 h-4 rounded"></div>

            <div class="w-1/3 mt-2 bg-gray-300 h-4 rounded"></div>
            <div class="w-2/3 mt-2 bg-gray-300 h-4 rounded"></div>
      ...
      <section class="md:flex items-center space-y-10 md:space-y-0 md:space-x-10">
        <div class="mx-auto md:w-1/2 rounded hidden md:block bg-white ">
          <div class="w-full mx-auto p-5 flex space-x-4 text-gray-600">
            ...
            <div class="bg-gray-300 h-64 w-1/3 rounded text-xs p-2">
              <div>Incident #42</div>

              <div class="w-full h-6 bg-gray-400 rounded mt-2"></div>

              <div class="mt-2">Events</div>

              <div class="h-4 w-1/3 bg-gray-400 rounded mt-2"></div>
              <div class="h-4 w-2/3 bg-gray-400 rounded mt-2"></div>

              <div class="h-4 w-1/3 bg-gray-400 rounded mt-2"></div>
              <div class="h-4 w-2/3 bg-gray-400 rounded mt-2"></div>

              <div class="h-4 w-1/3 bg-gray-400 rounded mt-2"></div>
              <div class="h-4 w-2/3 bg-gray-400 rounded mt-2 animate-ping"></div>
            </div>
          </div>
        ...
        <div class="md:w-1/2 bg-gray-800 bg-opacity-50 p-10 rounded">
          <h2 class="text-4xl md:text-5xl leading-none font-bold mb-6">
            Centralized effort
          </h2>
        ...
        <div class="mx-auto md:w-1/2 md:hidden bg-white rounded p-5">
          <div class="w-full mx-auto flex space-x-4 text-gray-600">
            <div class="grid grid-flow-col grid-cols-1 md:grid-cols-2 grid-rows-2 gap-4 w-2/3">
              <div class="bg-gray-300 p-2 rounded flex items-end">
                <div class="text-xs w-full flex justify-between items-center">
                  Michael Scott <FaSolidMicrophoneSlash />
      ...
      <section class="md:flex items-center space-y-10 md:space-y-0 md:space-x-10">
        <div class="md:w-1/2 bg-gray-800 bg-opacity-50 p-10 rounded">
          ...
          <p class="text-2xl md:text-3xl">
            Keep incidents up to date with tools you already know and love, like{' '}
            <span class="font-bold border-b-4 border-green-500">Slack</span> and{' '}
            <span class="font-bold border-b-4 border-green-500">
              the command line
            </span>
            .
        ...
        <div class="bg-opacity-75 bg-gray-700 p-5 font-mono space-y-2 rounded mx-auto md:w-1/2">
          <div class="font-bold">
      ...
      <section class="md:flex items-center space-y-10 md:space-y-0 z-10 relative">
        <div class="md:w-1/2 hidden md:flex flex-col items-center text-gray-600">
          <div class="bg-white w-4/5 md:w-2/3 rounded p-4">
            <div class="uppercase text-xs text-gray-400">Runbook</div>
            <div class="flex justify-between items-center">
              <div>Too Many Pods</div>
              <div class="text-xs uppercase bg-gray-300 rounded px-2 p-1">
                Stale
              </div>
            </div>
            ...
            <div class="h-4 w-1/6 bg-gray-300 rounded mt-2"></div>
            <div class="h-4 w-1/3 bg-gray-300 rounded mt-2"></div>
            <div class="h-4 w-1/3 bg-gray-300 rounded mt-2"></div>
            <div class="h-4 w-1/6 bg-gray-300 rounded mt-2"></div>
            <div class="h-4 w-1/3 bg-gray-300 rounded mt-2"></div>
          </div>
          ...
          <div class="bg-white w-4/5 md:w-2/3 rounded p-4 shadow-xl -mt-48 ml-16 md:ml-20">
            <div class="uppercase text-xs text-gray-400">Postmortem</div>
            <div class="">Incident #42</div>

            <div class="mt-2 flex space-x-4 text-xs">
              <div class="bg-gray-300 p-4 rounded w-1/2">
        ...
        <div class="md:hidden flex flex-col items-center text-gray-600">
          <div class="bg-white w-4/5 md:w-2/3 rounded p-4">
            <div class="uppercase text-xs text-gray-400">Runbook</div>
            <div class="flex justify-between items-center">
              <div>Too Many Pods</div>
